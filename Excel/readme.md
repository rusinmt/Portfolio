...
Custom Formatting used ${\color{red}▼}$ <br>▼ $${\color{green}▲}$$ indicators showcasing values to previous year is linked to the dashoard as a Linked Picture using Othe Paste Options.
