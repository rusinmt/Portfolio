...
Custom Formatting used for <span style="color:red;">▼</span><span style="color:color10;">▲</span> indicators showcasing values to previous year is linked to the dashoard as a Linked Picture using Othe Paste Options.
